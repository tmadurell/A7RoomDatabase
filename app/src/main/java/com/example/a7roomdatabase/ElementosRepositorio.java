...
public class ElementosRepositorio {
    ...
    com.example.a7roomdatabase.ElementosBaseDeDatos.ElementosDao elementosDao;
    ...
    ElementosRepositorio(Application application){
        elementosDao = com.example.a7roomdatabase.ElementosBaseDeDatos.obtenerInstancia(application).obtenerElementosDao();
    }
